...
public class AddAccount extends JFrame {
	...
	public AddAccount() {
		...
		JButton btnAddCurrentAccount = new JButton("Ajouter compte trésorerie");
		...
		JButton button = new JButton("Ajoutez un compte simple");
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(getComponent(0), "Deja ouvert", "Warning", 0);
				}
		...
		JButton btnAddStudentAccount = new JButton("Ajoutez un compte étudiant");
		...
		JLabel lblAddAccount = new JLabel("Ajouter compte");
