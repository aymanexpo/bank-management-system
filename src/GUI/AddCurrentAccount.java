...
public class AddCurrentAccount extends JFrame {
	...
	public AddCurrentAccount() {
		setTitle("Ajoutez un compte simple");
		...
		JLabel lblAddCurrentAccount = new JLabel("Ajoutez un compte simple ");
		...
		JLabel lblBalance = new JLabel("Solde:");
		...
		JLabel lblMaximumWithdrawLimit = new JLabel("Licence Numero :");
		...
		JButton btnAdd = new JButton("Ajoutez");
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(getComponent(0),"Reéssayer !!");
					textField.setText(null);
					textField_1.setText(null);
					textField_2.setText(null);
				}
				...
				int ch=JOptionPane.showConfirmDialog(getComponent(0), "Confirmer ?");
				if(ch==0)
				{
					int index = 0;
					try {
					...
					JOptionPane.showMessageDialog(getComponent(0),"Compte ajouté");
					dispose();
				}
				else 
				{
					JOptionPane.showMessageDialog(getComponent(0),"Echec");
					textField.setText(null);
					textField_1.setText(null);
					textField_2.setText(null);
				}
