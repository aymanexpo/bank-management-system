...
public class WithdrawAcc extends JFrame implements Serializable {
	...
	public WithdrawAcc() {
		...
		JLabel lblDepositToAccount = new JLabel("Tirer du compte");
		...
		JButton btnDeposit = new JButton("Tirer");
				...
				amt=Double.parseDouble(textField_1.getText());
					try {
						...
						if(a==0)
						{
							...
							JOptionPane.showMessageDialog(getComponent(0),"Tirage Succés");
							dispose();
						}
						else
						{
						...
						JOptionPane.showMessageDialog(getComponent(0), "Solde insuffisant");
						...
						JOptionPane.showMessageDialog(getComponent(0), "Limite de tirage dépassé");
						JOptionPane.showMessageDialog(getComponent(0),"Echec");
						textField.setText(null);
						textField_1.setText(null);
						
					} catch (InvalidAmount e1) {
						JOptionPane.showMessageDialog(getComponent(0), "Montant non valide");
						JOptionPane.showMessageDialog(getComponent(0),"Echec");
						textField.setText(null);
						textField_1.setText(null);
					}
